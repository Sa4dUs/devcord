...
import { BubbleContainerLogic, BubbleData } from './bubbleContainerLogic/bubbleContainerLogic.component';
...
export class BubbleContainer implements AfterViewInit {
  ...
  addBubble() {
    ...
    for (let attempt = 0; attempt < maxAttempts; attempt++) {
      ...
      const collision = this.bubbleRects.some((r) => this.logic.isColliding(r, fakeRect));
